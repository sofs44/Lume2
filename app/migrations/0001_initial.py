    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.metaterapeutica')),
        ...
        migrations.AddField(
            model_name='metaterapeutica',
            name='usuario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.usuario', verbose_name='Meta para o usuário'),
        ),
        migrations.CreateModel(
            name='Diario',
            fields=[
